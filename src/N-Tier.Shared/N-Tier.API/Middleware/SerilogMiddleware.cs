...
public class SerilogMiddleware
{
    ...
    public async Task Invoke(HttpContext httpContext)
    {
        ...
        try
        {
            ...
            var log = level == LogEventLevel.Error ? LogForErrorContext(httpContext, GetType().Assembly.GetName().Version.ToString()) : Log;
    ...
    static bool LogException(HttpContext httpContext, Stopwatch sw, Exception ex, string AppVersion)
    {
        sw.Stop();
    ...
    static ILogger LogForErrorContext(HttpContext httpContext, string AppVersion)
    {
